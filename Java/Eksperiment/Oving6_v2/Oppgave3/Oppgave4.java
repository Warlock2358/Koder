package Java.Eksperiment.Oving6_v2.Oppgave3;
...
class Oppgave4 {
    ...
    public static void visMeny() {
        ...
        switch (menyInput) {
            case 1:
                matrise[1] = Matrise
                        .fyllMatrise(lagMatrise(matrise[0].getAntallRader(), matrise[0].getAntallKolonner()));
            ...
            case 2:
                System.out.println(
                        "Lag matrise nr. 2 (antall rader må være lik " + matrise[0].getAntallKolonner() + "):");
                ...
                if (b != null) {
                    ...
                    System.out
                            .println("Noe gikk galt, antall kolonner i matrise 1 må være lik antall rader i matrise 2");
                }
                break;
            case 3:
                ...
                break;
            default:
                System.out.println("Du må taste inn et tall mellom 1 og 3");
                visMeny();
                break;
        }
    }
